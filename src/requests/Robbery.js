...
export default class Ambulance extends Component {
  ...
  render() {
        ...
        <View style={{marginRight:50}}>
         ...
         <Icon name="md-arrow-round-back" size={30} color="#E62626" />
          ...
          <View style={{marginLeft:90}}>
            ...
            source={require('../images/police.jpeg')}/>
          </View>
          </View>
          <Text style={{fontSize:20,color:'#000',marginLeft:50}}>Robbery responce services</Text>
    ...
    <TextInput
          ...
          borderWidth: 1,borderRadius:3,marginLeft:5,marginRight:5, borderWidth: 1,marginTop:10,marginBottom:5}}
          placeholder='Number of people injured'
          
          />
         <TextInput
          style={{height: 40, borderColor: 'gray',borderColor: 'red',
          borderWidth: 1,marginLeft:5,marginRight:5, borderRadius:3,borderWidth: 1,marginTop:10,marginBottom:5}}
          placeholder='short description of the condition'
          
          />  
    <View style={{flexDirection:'row',paddingTop:20}}>
      <TouchableOpacity>
      <View style={{ marginLeft:10 ,marginRight:20,paddingLeft: 10,}}>
      ...
      <TouchableOpacity> 
      <View style={{borderRadius:20,marginRight:5 ,marginLeft:125,paddingRight: 10,}} >
      <Button
